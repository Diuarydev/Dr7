...
hubFrame.Position = UDim2.new(0.5, -260, 0.5, -210)
...
logoIcon.Position = UDim2.new(0,15,0,5)
...
sidebar.Size = UDim2.new(0,118,1,-55)
...
-- Largura aumentada para aproveitar o espaço extra
-- CONTENT AREA COM SCROLL
local contentArea = Instance.new("ScrollingFrame", hubFrame)
contentArea.Size = UDim2.new(1, -133, 1, -58)
...
local function createButton(text, icon, parent, yPos)
    ...
    local textLabel = Instance.new("TextLabel", btn)
    textLabel.Size = UDim2.new(0,270,0,42)
...
for _, item in ipairs(itensReroll) do
    ...
    btnIniciar.Size = UDim2.new(0,190,0,38)
    ...
    btnParar.Size = UDim2.new(0,190,0,38)
    btnParar.Position = UDim2.new(0,210,0,yPosReroll)
...
respirationDelayInput.Size = UDim2.new(0,400,0,35)
...
do
    ...
    dmgDelayBox.Size = UDim2.new(0,400,0,35)
...
haloInfo.Size = UDim2.new(0,400,0,40)
...
exchangeDelayInput.Size = UDim2.new(0,400,0,35)
...
talismaInfo.Size = UDim2.new(0,400,0,50)
...
equipButton.Size = UDim2.new(0,400,0,45)
...
talismaDesc.Size = UDim2.new(0,400,0,45)
...
fusePotionInfo.Size = UDim2.new(0,400,0,45)
...
for _, potionData in ipairs(potionButtons) do
    ...
    local label = Instance.new("TextLabel", btn)
    label.Size = UDim2.new(0,330,0,45)
    label.Position = UDim2.new(0,50,0,0)
    label.BackgroundTransparency = 1
...
octInfo.Size = UDim2.new(0,400,0,45)
...
octAttackSlider.Size = UDim2.new(0,400,0,8)
...
octLoopSlider.Size = UDim2.new(0,400,0,8)
